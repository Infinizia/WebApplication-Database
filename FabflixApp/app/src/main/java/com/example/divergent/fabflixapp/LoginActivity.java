...
public class LoginActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean logOutStatus = getIntent().getBooleanExtra("logout", false);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //Create a JSON object for the login inputs
            ...
            LoginTask loginRequest = new LoginTask();
            loginRequest.execute(loginTask);
    ...
    public class LoginTask extends AsyncTask<MyTask,String,String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("\"fail\""))
            {
                ...
                alertDialog.setMessage("Wrong email or password. Please try again");
